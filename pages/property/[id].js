import { Box, Flex,Text,Badge,Spacer,Avatar } from '@chakra-ui/react'
     ...
     <Box w='full' p='6'></Box>
      ...
      <Text lineHeight='2' color='gray.600'>{description}</Text>
        ...
        <Flex flexWrap='wrap' textTransform='uppercase' justifyContent='space-between'>
            <Flex justifyContent='space-between' w='200px' borderBottom='1px' borderColor='gray.100' p='3'>
             <Text>Type</Text>
           ...
           <Flex>
           {furnishingStatus && (
        <Flex justifyContent='space-between' w='260px' borderBottom='1px' borderColor='gray.100' p='3' >
...
export async function getServerSideProps({ params: { id } }) {
    const data = await api(`${url}/properties/detail?externalID=${id}`);
